...
const ARTICLE_COMMENT_INCORRECT_FORMAT                                            = 10146;
const ARTICLE_PARENT_COMMENT_NOT_FOUND                                            = 10147;
const WRONG_CONTACT_NUMBER_FORMAT                                                 = 10148;
const ARTICLE_COMMENT_NOT_FOUND                                                   = 10149;
const UNAUTHORIZED_TO_REMOVE_THIS_ARTICLE_COMMENT                                 = 10150;
const UNAUTHORIZED_TO_UPDATE_THIS_ARTICLE_COMMENT                                 = 10151;
const CONVERSATION_NOT_FOUND                                                      = 10152;
const NOT_MEMBER_OF_THIS_CONVERSATION                                             = 10153;
const NO_PARTICIPANTS_PROVIDED_FOR_THIS_CONVERSATION                              = 10154;
const A_CONVERSATION_WITH_THESE_PARTICIPANTS_EXISTS                               = 10155;
...
const NO_FILE_PROVIDED                                                            = 10160;
const ELEMENT_NOT_PART_OF_PROVIDED_SERVICE                                        = 10161;
const UNAUTHORIZED_TO_MOVE_FOLDERS                                                = 10162;
const UNAUTHORIZED_TO_MOVE_FILES                                                  = 10163;
const FOLDER_HAS_BEEN_DELETED                                                     = 10164;
const ERROR_WHILE_GENERATING_TOKEN                                                = 10165;

const MOVE_ELEMENT_FUNCTION_ELEMENT_REMOVED                                       = '000-000-001';
const MOVE_ELEMENT_FUNCTION_TARGET_FOLDER_REMOVED                                 = '000-000-002';
const MOVE_ELEMENT_FUNCTION_ELEMENT_NOT_FOUND                                     = '000-000-003';
const MOVE_ELEMENT_FUNCTION_ELEMENT_NOT_PART_OF_PROVIDED_SERVICE                  = '000-000-004';
const MOVE_ELEMENT_FUNCTION_TARGET_FOLDER_NOT_FOUND                               = '000-000-005';
const MOVE_ELEMENT_FUNCTION_TARGET_SAME_AS_ELEMENT_TO_MOVE                        = '000-000-006';
const MOVE_ELEMENT_FUNCTION_CANNOT_MOVE_ELEMENT_TO_THE_SAME_TARGET                = '000-000-007';
const MOVE_ELEMENT_FUNCTION_DUPLICATE_NAME                                        = '000-000-008';
...
const RESET_PASSWORD_GENERATION_FAILED                                            = '001-001-001';
const RESET_PASSWORD_EMAIL_NOT_SENT                                               = '001-001-002';
const RESET_PASSWORD_DATABASE_UPDATE_FAILED                                       = '001-001-003';

const CREATE_STOPPAGE_INVALID_GENDER                                              = '002-000-001';
const CREATE_STOPPAGE_INVALID_TYPE                                                = '002-000-002';
const CREATE_STOPPAGE_INVALID_REGISTRATION_NUMBER                                 = '002-000-003';
const CREATE_STOPPAGE_INVALID_FIRSTNAME                                           = '002-000-004';
const CREATE_STOPPAGE_INVALID_LASTNAME                                            = '002-000-005';
const CREATE_STOPPAGE_INVALID_START_DATE                                          = '002-000-006';
const CREATE_STOPPAGE_INVALID_SENT_DATE                                           = '002-000-007';
const CREATE_STOPPAGE_INVALID_END_DATE                                            = '002-000-008';
const CREATE_STOPPAGE_START_DATE_AFTER_SENT_DATE                                  = '002-000-009';
const CREATE_STOPPAGE_START_DATE_AFTER_END_DATE                                   = '002-000-010';
const CREATE_STOPPAGE_ATTACHMENT_REQUIRED                                         = '002-000-011';
const CREATE_STOPPAGE_UNAUTHORIZED_ATTACHMENTS                                    = '002-000-012';
const CREATE_STOPPAGE_ESTABLISHMENT_NOT_FOUND                                     = '002-000-013';
const CREATE_STOPPAGE_CORRESPONDENCE_TYPE_NOT_FOUND                               = '002-000-014';
const CREATE_STOPPAGE_INITIAL_ATTACHMENT_REQUIRED                                 = '002-000-015';
const CREATE_STOPPAGE_INITIAL_ATTACHMENT_OVERFLOW                                 = '002-000-016';

const STOPPAGE_DETAIL_NOT_FOUND                                                   = '002-001-001';

const ADD_PROLONGATION_INVALID_END_DATE                                           = '002-002-001';
const ADD_PROLONGATION_UNAUTHORIZED_ATTACHMENT                                    = '002-002-002';
const ADD_PROLONGATION_STOPPAGE_NOT_FOUND                                         = '002-002-003';
const ADD_PROLONGATION_FORBIDDEN_BY_STATUS                                        = '002-002-004';
const ADD_PROLONGATION_END_DATE_HAPPENS_BEFORE_PREVIOUS_END                       = '002-002-005';
...
const ARTICLE_COMMENT_CREATED_SUCCESSFULLY                                        = 20051;
const ARTICLE_COMMENT_REMOVED_SUCCESSFULLY                                        = 20052;
const ARTICLE_COMMENT_UPDATED_SUCCESSFULLY                                        = 20053;
const MESSENGER_MESSAGE_SENT_SUCCESSFULLY                                         = 20054;
...
const STOPPAGE_CREATED_SUCCESSFULLY                                               = 20060;
const UNIT_NAME_UPDATED_SUCCESSFULLY                                              = 20061;
const PROLONGATION_ADDED_SUCCESSFULLY                                             = 20062;
...
module.exports =
{
  ...
  ARTICLE_COMMENT_INCORRECT_FORMAT: ARTICLE_COMMENT_INCORRECT_FORMAT,
  ARTICLE_PARENT_COMMENT_NOT_FOUND: ARTICLE_PARENT_COMMENT_NOT_FOUND,
  WRONG_CONTACT_NUMBER_FORMAT: WRONG_CONTACT_NUMBER_FORMAT,
  ARTICLE_COMMENT_NOT_FOUND: ARTICLE_COMMENT_NOT_FOUND,
  UNAUTHORIZED_TO_REMOVE_THIS_ARTICLE_COMMENT: UNAUTHORIZED_TO_REMOVE_THIS_ARTICLE_COMMENT,
  UNAUTHORIZED_TO_UPDATE_THIS_ARTICLE_COMMENT: UNAUTHORIZED_TO_UPDATE_THIS_ARTICLE_COMMENT,
  CONVERSATION_NOT_FOUND: CONVERSATION_NOT_FOUND,
  NOT_MEMBER_OF_THIS_CONVERSATION: NOT_MEMBER_OF_THIS_CONVERSATION,
  NO_PARTICIPANTS_PROVIDED_FOR_THIS_CONVERSATION: NO_PARTICIPANTS_PROVIDED_FOR_THIS_CONVERSATION,
  A_CONVERSATION_WITH_THESE_PARTICIPANTS_EXISTS: A_CONVERSATION_WITH_THESE_PARTICIPANTS_EXISTS,
  ...
  ELEMENT_NOT_PART_OF_PROVIDED_SERVICE: ELEMENT_NOT_PART_OF_PROVIDED_SERVICE,
  UNAUTHORIZED_TO_MOVE_FOLDERS: UNAUTHORIZED_TO_MOVE_FOLDERS,
  UNAUTHORIZED_TO_MOVE_FILES: UNAUTHORIZED_TO_MOVE_FILES,
  ERROR_WHILE_GENERATING_TOKEN: ERROR_WHILE_GENERATING_TOKEN,
  ...
  ARTICLE_COMMENT_CREATED_SUCCESSFULLY: ARTICLE_COMMENT_CREATED_SUCCESSFULLY,
  ARTICLE_COMMENT_REMOVED_SUCCESSFULLY: ARTICLE_COMMENT_REMOVED_SUCCESSFULLY,
  ARTICLE_COMMENT_UPDATED_SUCCESSFULLY: ARTICLE_COMMENT_UPDATED_SUCCESSFULLY,
  MESSENGER_MESSAGE_SENT_SUCCESSFULLY: MESSENGER_MESSAGE_SENT_SUCCESSFULLY,
  ...
  STOPPAGE_CREATED_SUCCESSFULLY: STOPPAGE_CREATED_SUCCESSFULLY,
  UNIT_NAME_UPDATED_SUCCESSFULLY: UNIT_NAME_UPDATED_SUCCESSFULLY,
  PROLONGATION_ADDED_SUCCESSFULLY: PROLONGATION_ADDED_SUCCESSFULLY,
  ...
  MOVE_ELEMENT_FUNCTION_ELEMENT_NOT_FOUND: MOVE_ELEMENT_FUNCTION_ELEMENT_NOT_FOUND,
  MOVE_ELEMENT_FUNCTION_ELEMENT_NOT_PART_OF_PROVIDED_SERVICE: MOVE_ELEMENT_FUNCTION_ELEMENT_NOT_PART_OF_PROVIDED_SERVICE,
  MOVE_ELEMENT_FUNCTION_TARGET_FOLDER_NOT_FOUND: MOVE_ELEMENT_FUNCTION_TARGET_FOLDER_NOT_FOUND,
  MOVE_ELEMENT_FUNCTION_TARGET_SAME_AS_ELEMENT_TO_MOVE: MOVE_ELEMENT_FUNCTION_TARGET_SAME_AS_ELEMENT_TO_MOVE,
  MOVE_ELEMENT_FUNCTION_CANNOT_MOVE_ELEMENT_TO_THE_SAME_TARGET: MOVE_ELEMENT_FUNCTION_CANNOT_MOVE_ELEMENT_TO_THE_SAME_TARGET,
  ...
  RESET_PASSWORD_GENERATION_FAILED: RESET_PASSWORD_GENERATION_FAILED,
  RESET_PASSWORD_EMAIL_NOT_SENT: RESET_PASSWORD_EMAIL_NOT_SENT,
  RESET_PASSWORD_DATABASE_UPDATE_FAILED: RESET_PASSWORD_DATABASE_UPDATE_FAILED,

  CREATE_STOPPAGE_INVALID_GENDER: CREATE_STOPPAGE_INVALID_GENDER,
  CREATE_STOPPAGE_INVALID_TYPE: CREATE_STOPPAGE_INVALID_TYPE,
  CREATE_STOPPAGE_INVALID_REGISTRATION_NUMBER: CREATE_STOPPAGE_INVALID_REGISTRATION_NUMBER,
  CREATE_STOPPAGE_INVALID_FIRSTNAME: CREATE_STOPPAGE_INVALID_FIRSTNAME,
  CREATE_STOPPAGE_INVALID_LASTNAME: CREATE_STOPPAGE_INVALID_LASTNAME,
  CREATE_STOPPAGE_INVALID_START_DATE: CREATE_STOPPAGE_INVALID_START_DATE,
  CREATE_STOPPAGE_INVALID_SENT_DATE: CREATE_STOPPAGE_INVALID_SENT_DATE,
  CREATE_STOPPAGE_INVALID_END_DATE: CREATE_STOPPAGE_INVALID_END_DATE,
  CREATE_STOPPAGE_START_DATE_AFTER_SENT_DATE: CREATE_STOPPAGE_START_DATE_AFTER_SENT_DATE,
  CREATE_STOPPAGE_START_DATE_AFTER_END_DATE: CREATE_STOPPAGE_START_DATE_AFTER_END_DATE,
  CREATE_STOPPAGE_ATTACHMENT_REQUIRED: CREATE_STOPPAGE_ATTACHMENT_REQUIRED,
  CREATE_STOPPAGE_UNAUTHORIZED_ATTACHMENTS: CREATE_STOPPAGE_UNAUTHORIZED_ATTACHMENTS,
  CREATE_STOPPAGE_ESTABLISHMENT_NOT_FOUND: CREATE_STOPPAGE_ESTABLISHMENT_NOT_FOUND,
  CREATE_STOPPAGE_CORRESPONDENCE_TYPE_NOT_FOUND: CREATE_STOPPAGE_CORRESPONDENCE_TYPE_NOT_FOUND,
  CREATE_STOPPAGE_INITIAL_ATTACHMENT_REQUIRED: CREATE_STOPPAGE_INITIAL_ATTACHMENT_REQUIRED,
  CREATE_STOPPAGE_INITIAL_ATTACHMENT_OVERFLOW: CREATE_STOPPAGE_INITIAL_ATTACHMENT_OVERFLOW,

  STOPPAGE_DETAIL_NOT_FOUND: STOPPAGE_DETAIL_NOT_FOUND,

  ADD_PROLONGATION_INVALID_END_DATE: ADD_PROLONGATION_INVALID_END_DATE,
  ADD_PROLONGATION_UNAUTHORIZED_ATTACHMENT: ADD_PROLONGATION_UNAUTHORIZED_ATTACHMENT,
  ADD_PROLONGATION_STOPPAGE_NOT_FOUND: ADD_PROLONGATION_STOPPAGE_NOT_FOUND,
  ADD_PROLONGATION_FORBIDDEN_BY_STATUS: ADD_PROLONGATION_FORBIDDEN_BY_STATUS,
  ADD_PROLONGATION_END_DATE_HAPPENS_BEFORE_PREVIOUS_END: ADD_PROLONGATION_END_DATE_HAPPENS_BEFORE_PREVIOUS_END
}
