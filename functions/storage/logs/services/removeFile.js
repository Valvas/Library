...
module.exports.addRemoveFileLog = (logType, accountID, fileID, fileName, fileExt, service, databaseConnector, callback) =>
{
        ...
        else
        {
          accountsGet.getAccountUsingID(accountID, databaseConnector, (error, account) =>
          {
            ...
            else
            {
              ...
              addRemoveFileLogInDatabase(logType, accountID, fileID, date, databaseConnector, (error) =>
              {
                error != null ? callback(error) :

                addRemoveFileLogInJSON(logType, accountID, fileID, fileName, fileExt, service, date, (error) =>
                {
...
function addRemoveFileLogInDatabase(logType, accountID, fileID, date, databaseConnector, callback)
{
...
function addRemoveFileLogInJSON(logType, accountID, fileID, fileName, fileExt, service, timestamp, callback)
{
