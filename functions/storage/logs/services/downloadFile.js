...
module.exports.addDownloadFileLog = (logType, accountId, fileUuid, serviceUuid, databaseConnection, params, callback) =>
{
...
function checkIfFileExistsInDatabase(logType, accountId, fileUuid, serviceUuid, databaseConnection, params, callback)
{
  storageAppFilesGet.getFileFromDatabaseUsingUuid(fileUuid, databaseConnection, params, (error, fileExists, fileData) =>
  {
    ...
    addDownloadFileLogInDatabase(logType, accountId, fileData, serviceUuid, currentTimestamp, databaseConnection, params, callback);
  });
}

/****************************************************************************************************/

function addDownloadFileLogInDatabase(logType, accountId, fileData, serviceUuid, currentTimestamp, databaseConnection, params, callback)
{
  ...
  }, databaseConnection, (error, result) =>
  {
    ...
    addDownloadFileLogInJSON(logType, accountId, fileData, serviceUuid, currentTimestamp, params, callback);
  });
}

/****************************************************************************************************/

function addDownloadFileLogInJSON(logType, accountId, fileData, serviceUuid, currentTimestamp, params, callback)
{
