...
module.exports.addDownloadFileLog = (logType, accountID, fileID, fileName, fileExt, service, databaseConnector, callback) =>
{
        ...
        else
        {
          accountsGet.getAccountUsingID(accountID, databaseConnector, (error, account) =>
          {
            ...
            else
            {
              ...
              addDownloadFileLogInDatabase(logType, accountID, fileID, date, databaseConnector, (error) =>
              {
                error != null ? callback(error) :

                addDownloadFileLogInJSON(logType, accountID, fileID, fileName, fileExt, service, date, (error) =>
                {
...
function addDownloadFileLogInDatabase(logType, accountID, fileID, date, databaseConnector, callback)
{
...
function addDownloadFileLogInJSON(logType, accountID, fileID, fileName, fileExt, service, timestamp, callback)
{
