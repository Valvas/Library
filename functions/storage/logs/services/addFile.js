...
module.exports.addUploadFileLog = (logType, accountId, fileUuid, serviceUuid, databaseConnection, params, callback) =>
{
...
function checkIfFileExistsInDatabase(logType, accountId, fileUuid, serviceUuid, databaseConnection, params, callback)
{
  storageAppFilesGet.getFileFromDatabaseUsingUuid(fileUuid, databaseConnection, params, (error, fileExists, fileData) =>
  {
    ...
    addUploadFileLogInDatabase(logType, accountId, fileData, serviceUuid, currentTimestamp, databaseConnection, params, callback);
  });
}

/****************************************************************************************************/

function addUploadFileLogInDatabase(logType, accountId, fileData, serviceUuid, currentTimestamp, databaseConnection, params, callback)
{
  ...
  }, databaseConnection, (error, result) =>
  {
    ...
    addUploadFileLogInJSON(logType, accountId, fileData, serviceUuid, currentTimestamp, params, callback);
  });
}

/****************************************************************************************************/

function addUploadFileLogInJSON(logType, accountId, fileData, serviceUuid, currentTimestamp, params, callback)
{
