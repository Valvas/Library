...
socket.on('conversationCreated', (conversationData) =>
{
  ...
  ? `<img class="messengerConversationPictureContent" src="${messengerData[currentConversationUuid].receiver.picture}" />`
  : `<img class="messengerConversationPictureContent" src="${conversationData.sender.picture}" />`;
